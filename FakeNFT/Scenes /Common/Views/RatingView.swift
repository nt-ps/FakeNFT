...
final class RatingView: UIStackView {
    ...
    private func createStarImageView() -> UIImageView {
        ...
        imageView.image = UIImage(resource: .Icons.star).withRenderingMode(.alwaysTemplate)
        return imageView
    }
    ...
    private func updateStars() {
        for (index, subview) in subviews.enumerated() {
            ...
            imageView.tintColor = index < rating ? .AppColors.Universal.yellow : .AppColors.lightGray
        }
    }
}
